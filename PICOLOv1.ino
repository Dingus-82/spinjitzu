...
void loop() {
  ...
  if ((millis() - nowTimeMS) >= loopTime) {
    ...
    data.concat(",");
    data.concat(String(vemlALS));
    data.concat(",");
    data.concat(String(vemlWhite));
    data.concat(",");
    data.concat(String(vemlLux));
    data.concat(",");
    data.concat(String(vemlStatus));
    data.concat(",");
